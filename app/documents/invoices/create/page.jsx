        ...
        <section className="border rounded-lg p-5 bg-white col-span-2 flex flex-col gap-5">
            <div className="grid grid-cols-5 gap-2">
                <div className="col-span-3  p-2">
                    <div className="border rounded-md p-3 flex items-center relative">
                        <input type="text" placeholder="Select Customer" className="w-full h-full outline-none focus:outline-none"/>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className=" w-5 h-5">
                            <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
                        </svg>
                        {/* <div className="absolute w-full bg-white rounded-lg left-0 top-14 border border-yellow-500">
                            <ul className="flex flex-col gap-1">
                                <li className="border-b p-3 ">Test User 1</li>
                                <li className="border-b p-3 ">Test User 1</li>
                                <li className="border-b p-3 flex items-center gap-2 text-emerald-500">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
...
<form>
    <label className="my-5">Note</label>
       ...
       <div className="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
           ...
           <button type="button" data-tooltip-target="tooltip-fullscreen" className="p-2 text-gray-500 rounded cursor-pointer sm:ml-auto hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
               <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 19 19">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" stroke-width="2" d="M13 1h5m0 0v5m0-5-5 5M1.979 6V1H7m0 16.042H1.979V12M18 12v5.042h-5M13 12l5 5M2 1l5 5m0 6-5 5"/>
                </svg>
   ...
   <button type="submit" className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-teal-500 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
       Save
   </button>
</form>
        ...
        <section className="border rounded-lg p-5 bg-white shadow shadow-neutral-200">
            <ul className="flex flex-col gap-5">
                ...
                <li className="flex justify-between items-center">Signature
  ...
  <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-red-300 dark:peer-focus:ring-red-800 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-red-600"></div>
                ...
                <li className="flex items-center justify-between">Recurring
