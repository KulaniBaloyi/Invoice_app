...
const Menu = () => {
  ...
  return (
    <aside className='border cols-span-1 flex flex-col gap-5 p-2 py-5 relative h-[100dvh] overflow-y-auto '>
            ...
            <h1 className='text-2xl font-semibold text-sky-500'>Invoice <span className='text-emerald-500'>App</span></h1>
            <div className='flex gap-4 items-center p-2 hover:bg-gray-200 cursor-pointer rounded-md'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
  
  
               <path fillRule="evenodd" d="M4.25 2A2.25 2.25 0 002 4.25v2.5A2.25 2.25 0 004.25 9h2.5A2.25 2.25 0 009 6.75v-2.5A2.25 2.25 0 006.75 2h-2.5zm0 9A2.25 2.25 0 002 13.25v2.5A2.25 2.25 0 004.25 18h2.5A2.25 2.25 0 009 15.75v-2.5A2.25 2.25 0 006.75 11h-2.5zm9-9A2.25 2.25 0 0011 4.25v2.5A2.25 2.25 0 0013.25 9h2.5A2.25 2.25 0 0018 6.75v-2.5A2.25 2.25 0 0015.75 2h-2.5zm0 9A2.25 2.25 0 0011 13.25v2.5A2.25 2.25 0 0013.25 18h2.5A2.25 2.25 0 0018 15.75v-2.5A2.25 2.25 0 0015.75 11h-2.5z" clipRule="evenodd" />
            </svg>
            <Link href="/dashboard">    <h2 className='text-gray-800 font-semibold'>Dashboard</h2></Link>
            ...
            <ul className='flex flex-col gap-2'>
              ...
              <li className='flex gap-5 items-center hover:bg-gray-200 p-2 rounded-md'>
...
<Link href="/documents/invoices">Invoice</Link>


              </li>
              <li className='flex items-center gap-5 hover:bg-gray-200 p-2 rounded-md'>
...
<h2>Estimate</h2>
            ...
            <ul className='flex gap-5 flex-col'>
              <div  onClick={()=>setIsOpen(!isOpen)} className='cursor-pointer flex items-center gap-2 hover:bg-gray-200 p-2 rounded-md'>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
              ...
              {isOpen&&(
                <>
                  <li className='flex gap-2 hover:bg-gray-200 p-2 rounded-md '>
...
<h2>My reports</h2>
            ...
            <div className='self-start bg-sky-500 grid place-content-center p-2 rounded-full'>
